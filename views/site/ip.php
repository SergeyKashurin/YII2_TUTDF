...
$this->title = 'Формирование кредитной истории индивидуального предпринимателя. (Ануитентный график)';
...
<div class="site-index">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h4>Для того чтобы сформировать файлы выгрузки кредитной истории, необходимо выполнить следующий шаг:</h4>
            <!-- Шаги по созданию КИ -->
            ...
            <blockquote>
                <p>Сегмент общих данных по индивидуальному предпринимателю</p>
                <footer>
                    Содержит общую информацию об ИП
                </footer>
            </blockquote>
            ...
            <blockquote>
                <p>Сегмент личных данных по индивидуальному предпринимателю</p>
                <footer>
                    Содержит персональную информацию об ИП
                </footer>
            </blockquote>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <?=$form->field($model, 'RegNumIP')->label('Регистрационный номер предпринимателя')->textInput(['placeholder' => '304071632100072', 'type' => 'number'])->error(); ?>
                </div>
                <div class="col-md-3">
            ...
            <blockquote>
                <p>Сегмент адресных данных по индивидуальному предпринимателю</p>
                <footer>
            ...
            <blockquote>
                <p>Сегмент телефонных данных по индивидуальному предпринимателю</p>
                <footer>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <?=$form->field($model, 'KredScetType')->label('Тип счёта')->dropDownList(['10' => '10 - На развитие бизнеса', '11' => '11 - На пополнение оборотных средств', '12' => '12 - На покупку оборудования', '13' => '13 - На строительство'])->error(); ?>
                </div>
                <div class="col-md-3">
                    <?=$form->field($model, 'KredScetOtn')->label('Отношение к счёту')->dropDownList(['9' => '9 - Юридическое лицо', '4' => '4 - Совместный'])->error(); ?>
                </div>
                <div class="col-md-3">
...
<!--                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-9">
                    <?=$form->field($model, 'operationType')->label('Тип операции: заведение КИ ИП')->textInput(['value' => 'ip', 'type' => 'hidden'])->error(); ?>
                </div>
                <div class="col-md-3">
